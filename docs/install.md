...
## Chromebook, and any other computer
...
The Windows and macOS apps do not update themselves yet.
When there is a new version, download it from this page and install it over the old one; your gradebook is a separate file and is not touched.
