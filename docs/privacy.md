...
Gradebook is published by Justin Delano, an individual developer.
It is not a company, a school, or a district, and it operates no servers.

This policy is short because there is very little to describe.

## The short version

Gradebook collects nothing about you and nothing about your students.
...
## What Gradebook stores, and where
...
Gradebook's use of information received from Google APIs adheres to the [Google API Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy), including the Limited Use requirements.
...
Gradebook is a tool a teacher runs on their own device, in the way a spreadsheet is.
...
Because the data stays in your possession, using Gradebook does not create a disclosure of student records to a third party.
...
Gradebook is not directed at children and children do not use it.
...
If this policy changes, the effective date at the top changes with it, and the previous versions remain readable in [the history of this page](https://github.com/justin-delano/gradebook/commits/main/docs/privacy.md).

A change that would mean collecting something, rather than nothing, would be announced in the app and not only here.

## Getting in touch

Questions about this policy, or about anything on it, go to [the issue tracker](https://github.com/justin-delano/gradebook/issues).
